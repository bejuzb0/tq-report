...
def main():
    ...
    plot_cross_vs_same(rdir / f"{args.dataset}_main_results.csv", fig_dir / f"{args.dataset}_fig_cross_vs_same.png")
    plot_memory_tradeoff(rdir / f"{args.dataset}_main_results.csv", rdir / f"{args.dataset}_profiles.csv",
                         fig_dir / f"{args.dataset}_fig_memory_tradeoff.png")
