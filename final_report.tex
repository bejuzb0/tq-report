...
\begin{itemize}[itemsep=0pt]
  \item \textbf{Code repository (V1):} \url{https://github.com/QUASARS06/turboquant-clip}
  \item \textbf{Code repository (V2):} \url{https://github.com/bejuzb0/turboclip-quantization}
\end{itemize}
